%% import data
data = readtable("PMPP_nonprotonated.csv");

%% data modification
wavelengths = table2array(data(1:1203, 1));
a= table2array(data(1:1203, 2:2:20));
c= [1.0e-5 2.0e-5 3.0e-5 4.0e-5 5.0e-5 6.0e-5 7.0e-5 8.0e-5 9.0e-5 10.0e-5];
...
legend('10 µM', '20 µM', '30 µM', '40 µM', '50 µM', '60 µM', '70 µM', '80 µM', '90 µM', '100 µM', 'FontSize', 12, 'Interpreter','latex')
legend boxoff
xlim([200 450])
ylim([0 3.7])
...
legend('PMPP in MeCN', 'fontsize', 15, 'Interpreter','latex')
legend boxoff